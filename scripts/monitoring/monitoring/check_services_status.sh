...
if [ $bitcoind_enabled == "enabled" ] && [ "$bitcoind_status" != "active \\(running\\)" ]; then
...
if [ $electrs_enabled == "enabled" ] && [ "$electrs_status" != "active \\(running\\)" ]; then
...
if [ $btcrpcexplorer_enabled == "enabled" ] && [ "$btcrpcexplorer_status" != "active \\(running\\)" ]; then
...
if [ $mempool_enabled == "enabled" ] && [ "$mempool_status" != "active \\(running\\)" ]; then
...
if [ $jmwalletd_enabled == "enabled" ] && [ "$jmwalletd_status" != "active \\(running\\)" ]; then
...
if [ $obwatcher_enabled == "enabled" ] && [ "$obwatcher_status" != "active \\(running\\)" ]; then
...
if [ $jam_enabled == "enabled" ] && [ "$jam_status" != "active \\(running\\)" ]; then
...
if [ $lnd_enabled == "enabled" ] && [ "$lnd_status" != "active \\(running\\)" ]; then
...
if [ $rtl_enabled == "enabled" ] && [ "$rtl_status" != "active \\(running\\)" ]; then
